...
- **Per-scenario overrides:** `profile:`, `notes:`, `tags:`, `viewports:`, the permission keys (`grantPermissions:`, `denyPermissions:`, `geolocation:`), `cookies:`, and `storage:` placed immediately under a heading (before the prose) override the file-level defaults.

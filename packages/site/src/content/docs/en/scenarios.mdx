...
- **Per-scenario overrides:** `profile:`, `notes:`, `tags:`, the permission keys (`grantPermissions:`, `denyPermissions:`, `geolocation:`), and `cookies:` placed immediately under a heading (before the prose) override the file-level defaults.

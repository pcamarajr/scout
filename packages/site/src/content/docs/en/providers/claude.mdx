---
title: "Claude (Anthropic) — default"
description: "Scout's default provider, on the trusted Claude Agent SDK engine. The credential detection order, the zero-config Claude Code happy path, and the AI SDK caveat."
sidebarLabel: "Claude"
order: 14
group: "Reference"
parent: "providers"
tags: ["providers", "claude", "anthropic"]

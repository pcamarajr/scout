---
title: "Google (Gemini)"
description: "Run Scout on Gemini via the AI SDK engine. The network-free credential detection order — Gemini API key or keyless Vertex AI with Application Default Credentials."
sidebarLabel: "Gemini"
order: 15
group: "Reference"
parent: "providers"
tags: ["providers", "gemini", "google"]
